...
scope: framework-role-orchestration
recommended_start: fullstack-contract-orchestrator
---
...
- This file defines the practical workflow for using the framework role system without losing architectural alignment.
...
```text
Start with DOC/framework/roles/ai-context.yaml and use the fullstack-contract-orchestrator role.
...
Phase 2: use frontend-ui-ux-generator to create frontend docs from the shared blueprint.
