      ...
      <section className="bg-[#0f2040] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-3xl">
            <span className="text-[#c8a84b] text-xs font-bold uppercase tracking-widest mb-4 block">Case Study</span>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-4 mb-10">
            {["Commodity", "Volume", "Corridor"].map((label) => (
              <div key={label} className="bg-[#f8f9fa] rounded-lg p-4 text-center border border-[#e5e7eb]">
                <p className="text-xs text-[#6b7280] mb-1">{label}</p>
                <p className="font-bold text-[#0f2040]">—</p>
              </div>
            ))}
          </div>
          <h2 className="text-xl font-bold text-[#0f2040] mb-4">The Challenge</h2>
          ...
          <h2 className="text-xl font-bold text-[#0f2040] mb-4">Our Approach</h2>
          <p className="text-[#6b7280] leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-bold text-[#0f2040] mb-4">Result</h2>
