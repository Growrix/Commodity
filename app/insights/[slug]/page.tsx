      ...
      <section className="bg-[#0f2040] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-3xl">
            <span className="text-[#c8a84b] text-xs font-bold uppercase tracking-widest mb-4 block">Market Intelligence</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            <article className="lg:col-span-2 prose prose-lg max-w-none">
              ...
              <h2 className="text-xl font-bold text-[#0f2040] mt-8 mb-4">Market Overview</h2>
              ...
              <h2 className="text-xl font-bold text-[#0f2040] mt-8 mb-4">Key Signals</h2>
              <p className="text-[#6b7280] leading-relaxed mb-6">
              ...
              <h2 className="text-xl font-bold text-[#0f2040] mt-8 mb-4">Commercial Implications</h2>
            ...
            <aside className="space-y-4">
              ...
              <div className="bg-[#f8f9fa] rounded-xl p-6 border border-[#e5e7eb]">
                <h3 className="font-bold text-[#0f2040] mb-3">More Insights</h3>
                <div className="space-y-3">
                  {["Urea Market Dynamics", "Red Sea Routing Strategies", "Palm Oil Outlook 2026"].map((t) => (
                    <Link
                      key={t}
                      href="/insights"
                      className="flex items-center gap-2 text-sm text-[#374151] hover:text-[#c8a84b] transition-colors"
                    >
